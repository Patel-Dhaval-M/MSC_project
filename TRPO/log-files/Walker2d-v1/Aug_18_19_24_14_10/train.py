...
def main(env_name, num_episodes, gamma, lam, kl_targ, batch_size, hid1_mult, policy_logvar, no_of_updates):
    """ Main training loop
    ...
    now = datetime.utcnow().strftime("%b_%d_%H_%M_%S")  # create unique directories
    ...
    policy = Policy(obs_dim, act_dim, kl_targ, hid1_mult, policy_logvar, no_of_updates)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--no_of_updates', type=float,
                        help='no of epochs',
                        default=10)
